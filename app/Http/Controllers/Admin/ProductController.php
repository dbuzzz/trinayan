            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('status', function($row){
                        ...
                        if ($row->active_status == 1) {
                           $btn .= '<span class="badge badge-success" style="cursor:pointer;">Active</span>';
                        }else{
                           $btn .= '<span class="badge badge-warning" style="cursor:pointer;"">De-Active</span>';

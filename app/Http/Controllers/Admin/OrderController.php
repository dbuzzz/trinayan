...
class OrderController extends Controller
{
    ...
    public function careerShow(Request $request){
        if ($request->ajax()) {
            $data = Contact::query();
            ...
            return DataTables::of($data)
                    ...
                    ->addColumn('action', function($row){
                        $btn = '<ul class="orderDatatable_actions mb-0 d-flex flex-wrap" style="min-width:90px;justify-content:unset;"> ';
                        $btn .= '<li > <a href="'.$row->subject.'" download class="edit" target="_blank"> <i class="fa fa-file"></i></a> </li>';
    ...
    public function export(Request $request){
        ...
        // ];
        $datas[0] = array('Name','Email','Phone','Message','Type');
        ...
        foreach ($data as $key => $value) {
            ...
            $datas[$key+1] = array($value->name,$value->email,$value->phone,$value->message,$type);
        }

...
Route::middleware("VendorAuth")->group(function(){
    ...
    Route::group(['prefix' => 'project-management'], function() {
        Route::get('/', [ProjectController::class,'index'])->name('project-management.index');
        Route::get('/viewVariants', [ProjectController::class,'viewVariants'])->name('project-management.viewVariants');

        Route::get('/view', [ProjectController::class,'view'])->name('project-management.view');
        Route::post('/save', [ProjectController::class,'save'])->name('project-management.save');
        Route::get('/show', [ProjectController::class,'show'])->name('project-management.show');
        Route::get('/status', [ProjectController::class,'status'])->name('project-management.status');

        Route::get('/price_calc', [ProjectController::class,'price_calc'])->name('project-management.price_calc');
        Route::get('/delete', [ProjectController::class,'delete'])->name('project-management.delete');
        Route::get('/edit', [ProjectController::class,'edit'])->name('project-management.edit');
        Route::get('/sub_cat', [ProjectController::class,'sub_cat'])->name('project-management.sub_cat');
        Route::get('/getSearch', [ProjectController::class,'getSearch'])->name('project-management.getSearch');
        Route::post('/import_project', [ProjectController::class,'import_project'])->name('project-management.import_project');
    });
    ...
    Route::get('/careers', [OrderController::class,'career'])->name('career');
    Route::get('/careerShow', [OrderController::class,'careerShow'])->name('careerShow');
...
// ******************************frontend*************************************
    ...
    Route::get('/ongoing',[HomeController::class,'underConstruction']);
    Route::get('/upcoming',[HomeController::class,'upcoming']);
    Route::get('/disclaimer',[HomeController::class,'disclaimer']);
    Route::get('/projectDetail',[HomeController::class,'projectDetail'])->name('projectDetail');
    ...
    Route::post('/save_career',[HomeController::class , 'save_career']);

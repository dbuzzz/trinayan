...
<div class="privacy-banner">
  ...
  <div class="privacy-policy container mt-5">
    <div class="elementor-widget-container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "We", "Us" or "Our" in this Agreement) refers to Trinayan, Delhi.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Trinayan, accessible from
            <a
              href="{{url('/')}}"
      ...
      <h2><strong>Delete Your Personal Data</strong></h2>
      <p>
      ...
      <ul>
        <li>
          <p>By email: <a href="mailto:contact@trinayan.co.in">contact@trinayan.co.in</a></p>
        </li>
        <li>
          <p>
            ...
            <a
              ...
              rel="external nofollow noopener"
              target="_blank"
              >https://trinayan.co.in/contact</a
            >
          </p>
        </li>
        <li>
          <p>By phone number: <a href="tel:+91 9810031927">+91 9810031927</a></p>
        </li>
      </ul>
    </div>
  </div>

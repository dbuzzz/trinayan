...
<head>
  <meta charset="utf-8">
    ...
    <link rel="shortcut icon" href="{{asset('')}}frontend_assets/img/logo.png" type="image/x-icon">
    <!-- Theme style -->
...
<div class="wrapper">
  ...
  <header class="main-header bg-success">
    ...
    <a href="{{url('/category')}}" class="logo">
      <!-- mini logo -->
      <b class="logo-mini">
          <span class="light-logo"><img src="{{asset('')}}frontend_assets/img/logo.png"></span>
     </b>
      <!-- logo-->
      <span class="logo-lg">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="{{url('careers')}}">
            <i class="fa-sharp fa-solid fa-book"></i> <span>Career</span>
          </a>
        </li>
        ...
        <li>
          <a href="{{url('project-management')}}">
            <i class="fa-sharp fa-solid fa-book"></i> <span>Projects</span>
          </a>
        </li>
        <li>
          <a href="{{url('project-management/view')}}">
            <i class="fa-sharp fa-solid fa-book"></i> <span>View Projects</span>
          </a>
        </li>
